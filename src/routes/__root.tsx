    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <div className="mt-6">
          <Link
            to="/"
            className="inline-flex items-center justify-center rounded-md bg-red px-4 py-2 text-sm font-medium text-primary-foreground transition-colors hover:bg-red-2"
          >
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          Algo saiu do padrão. Você pode tentar novamente ou voltar ao início.
        </p>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Sora:wght@400;500;600;700;800&family=Manrope:wght@300;400;500;600;700&family=Instrument+Serif:ital@0;1&display=swap",
      },
    ],
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          name: "PUB FOOD",
          description:
            "Empresa da PUB CORE especializada em gestão, estruturação e desenvolvimento de restaurantes, deliveries e dark kitchens.",
